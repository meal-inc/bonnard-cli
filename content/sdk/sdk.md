...
**Reading order for new SDK users:** this page → [sdk.authentication](sdk.authentication) → [sdk.query-reference](sdk.query-reference) → [sdk.errors](sdk.errors) → then whichever integration guide fits your use case (React, browser, AI agents, chart libraries).
