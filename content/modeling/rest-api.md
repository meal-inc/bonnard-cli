...
When using the SDK programmatically, all API errors throw `BonnardError` with the HTTP status code:
...
See [sdk.errors](sdk.errors) for status codes, retry patterns, and common fixes.
